...
void setup()  //  Setup function
{
  ...
  Timer1.attachInterrupt(battery_voltage_measurement);  // battery_voltage_measurement function will be executed every 20 milli second
...
void battery_voltage_measurement()  // battery_voltage_measurement function starts
{
  ...
  else if (battery_voltage < 10.2 || battery_voltage > 14.4)  // if battery voltage is below 10.2v orabove 14.2v ,
  {
